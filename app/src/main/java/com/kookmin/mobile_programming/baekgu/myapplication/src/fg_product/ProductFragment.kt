...
class ProductFragment: BaseFragment<FragmentProductBinding>(FragmentProductBinding::bind, R.layout.fragment_product) {
    ...
    private fun setRecyclerView(){
        ...
        //소고기 볼
        beefBallProductList.add(RecommendProductListDataClass(R.drawable.bbx001_1,R.drawable.bbx001_2,R.drawable.bbx001_3,R.drawable.bbx001_4,"마늘"))
        beefBallProductList.add(RecommendProductListDataClass(R.drawable.bbx002_1,R.drawable.bbx002_2,R.drawable.bbx002_3,R.drawable.bbx002_4,"오리지널"))
        beefBallProductList.add(RecommendProductListDataClass(R.drawable.bbx003_1,R.drawable.bbx003_2,R.drawable.bbx003_3,R.drawable.bbx003_4,"청양고추"))

        //소고기 스테이크
        beefSteakProductList.add(RecommendProductListDataClass(R.drawable.bsx001_1,R.drawable.bsx001_2,R.drawable.bsx001_3,R.drawable.bsx001_4,"오리지널"))
        beefSteakProductList.add(RecommendProductListDataClass(R.drawable.bsx002_1,R.drawable.bsx002_2,R.drawable.bsx002_3,R.drawable.bsx002_4,"청양고추"))
        ...
        binding.fgProductRvChickenSteak.adapter=RecommendProductListRvAdapter(chickenSteakProductList)
        binding.fgProductRvChickenSteak.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)

        binding.fgProductRvSauceChicken.adapter=RecommendProductListRvAdapter(sauceChickenProductList)
        binding.fgProductRvSauceChicken.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)

        binding.fgProductRvFish.adapter=RecommendProductListRvAdapter(fishProductList)
        binding.fgProductRvFish.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)

        binding.fgProductRvBeefBall.adapter=RecommendProductListRvAdapter(beefBallProductList)
        binding.fgProductRvBeefBall.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)

        binding.fgProductRvBeefSteak.adapter=RecommendProductListRvAdapter(beefSteakProductList)
        binding.fgProductRvBeefSteak.layoutManager=LinearLayoutManager(requireContext(),LinearLayoutManager.HORIZONTAL,false)
